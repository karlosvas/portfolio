import { showModal, closeModal } from './logicModal.js';
...
document.addEventListener('DOMContentLoaded', (event) => {
   ...
   showModal(btnLogin!, divModal!);
   showModal(btnRegister!, divModal!);
   closeModal(btnClose!, divModal!);;
});


// Declare global variables for the theme switcher
declare global {
   interface Window {
